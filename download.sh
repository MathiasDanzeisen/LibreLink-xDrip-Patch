...
WORKDIR=$(pwd)
FILENAME='com.freestylelibre.app.de_2020-05-19' # version v2.4.2
...
wget -O APK/apkpure.html --keep-session-cookies --save-cookies cookies.txt https://apkpure.com/de/freestyle-librelink-de/com.freestylelibre.app.de/download/5960-APK
